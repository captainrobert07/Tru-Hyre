...
export const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    category: "AI",
    description: "Powers all AI features: match scoring, summaries, search, outreach, red-flags, chatbot.",
    fields: [
  ...
  },
  {
    ...
    category: "Signing",
    description: "Send offer letters for e-signature. Stores credentials; sending is invoked from the offer panel.",
    fields: [
  ...
  },
  {
    ...
    category: "Calendar",
    description: "Alternative to Google Calendar for interview events (Graph API).",
    fields: [
  ...
  },
  {
    ...
    category: "Job boards",
    description: "Push open roles to LinkedIn / Indeed / Naukri via their APIs.",
    fields: [
      { key: "linkedinToken", label: "LinkedIn token", secret: true },
      { key: "indeedKey", label: "Indeed publisher key", secret: true },
      { key: "naukriKey", label: "Naukri key", secret: true },
    ],
  },
  {
    key: "zapier",
    ...
    category: "Automation",
    description: "Fire events to a Zapier catch hook (complements native webhooks).",
    fields: [
      { key: "catchHookUrl", label: "Catch hook URL", secret: true, envFallback: "ZAPIER_HOOK_URL" },
    ],
  },
  {
    key: "transcription",
  ...
  },
  {
    ...
    category: "Auth",
    description: "Single sign-on via an OIDC/SAML identity provider. Scaffolded; activation requires provider setup.",
    fields: [
